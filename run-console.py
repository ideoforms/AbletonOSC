...
def main(args):
    ...
    words = [
        ...
        "/live/device/stop_listen/variations/num",
        "/live/device/start_listen/variations/selected",
        "/live/device/stop_listen/variations/selected",
        "/live/device/variations/recall",
        "/live/device/variations/recall_last",
        "/live/device/variations/store",
        "/live/device/variations/delete",
        "/live/device/variations/randomize",
